...
<context>
    ...
    <message>
        ...
        <translation>開啓 tesseract 協議的 URI 或付款要求</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>沒辦法啟動 tesseract 協議的按就付處理器</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Tesseract Alert" admin@foo.com
        ...
        <translation>要使用 tesseractd, 或是對 tesseract-qt 指定 -server 選項，你必須要在以下設定檔中設定 RPC 密碼(選項: rpcpassword):
%s
建議你使用以下隨機產生的密碼:
rpcuser=tesseractrpc
rpcpassword=%s
...
比如說設定: alertnotify=echo %%s | mail -s "Tesseract Alert" admin@foo.com
</translation>
    </message>
    <message>
