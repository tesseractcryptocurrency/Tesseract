...
// Copyright (c) 2014-2015 The Tesseract Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Tesseract Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // Tesseract: load fallback font in case Comic Sans is not availble on the system
    ...
    // Tesseract: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Tesseract: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tesseract address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tesseract: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Tesseract Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tesseract Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Tesseract Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tesseract addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tesseract addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Tesseract Core help message to get a list with possible Tesseract command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Tesseract Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tesseract network", "", count));
}
...
{
    QString strTitle = tr("Tesseract"); // default title
