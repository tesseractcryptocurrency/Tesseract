        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Tesseract: Disable free transactions
...
{
    // Tesseract: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Tesseract: Add an increased fee for each dust output
        nFeeNeeded += GetTesseractDustFee(tx.vout, minTxFee);
    }
