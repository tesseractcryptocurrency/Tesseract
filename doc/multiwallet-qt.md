...
In order to support loading of multiple wallets in tesseract-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to tesseract-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into tesseract-qt, and as such, will require some minor modifications to provide hooks for
